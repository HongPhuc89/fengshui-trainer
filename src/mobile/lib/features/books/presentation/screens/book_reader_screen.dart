...
class BookReaderScreen extends StatefulWidget {
  ...
  const BookReaderScreen({super.key, required this.slug, this.startChapter});
...
class _BookReaderScreenState extends State<BookReaderScreen>
  ...
  Widget build(BuildContext context) {
    // Rebuilds if the profile is still in flight when this screen opens —
    // AuthCubit.restoreSession() emits `user: null` first and fills it in
    // once the /users/me/ fetch it kicks off resolves.
